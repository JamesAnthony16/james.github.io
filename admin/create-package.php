...
<html>
<head>
<title>St. William Travel and Tours | Admin Package Creation</title>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price in Php" required>
									</div>
								</div>
